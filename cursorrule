...
- **每個 TDD 循環完成後**：必須立即更新工作日誌記錄具體進度、技術決策和遇到的問題
- **功能模組完成後**：必須更新架構文件、API 文件和使用說明
- **版本變更時**：必須同步更新 CHANGELOG.md、todolist.md 和版本記錄
- **知識分享責任**：將實作過程中的技術發現、最佳實踐和陷阱記錄在工作日誌中
...
#### 🔴 Red 階段：測試設計實作
**前置作業**：
- 閱讀 sage-test-architect 提供的測試設計規劃（如有）
- 分析功能需求，確定測試目標
...
#### 版本類型明確區分：
- **專案版本**：如 v0.9.8, v1.0.0（影響整個產品發布）
- **架構版本**：如事件系統架構 v2.0（內部技術架構升級）
- **功能版本**：如 API v1.2（特定功能模組版本）
