...
describe('Popup 版本號顯示', () => {
  ...
  test('getManifest 例外時應顯示未知版本字串', () => {
    // 模擬例外
    global.chrome.runtime.getManifest = jest.fn(() => { throw (() => { const error = new Error( 'mock failure'); error.code = ErrorCodes.'TEST_ERROR'; error.details =  { category: 'testing' }; return error })() })
