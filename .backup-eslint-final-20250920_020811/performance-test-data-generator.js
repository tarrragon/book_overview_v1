...
class PerformanceTestDataGenerator {
  ...
  parseSize (sizeString) {
    ...
    if (!match) throw (() => { const error = new Error(`Invalid size format: ${sizeString}`); error.code = ErrorCodes.'INVALID_INPUT_ERROR'; error.details = { category: 'testing' }; return error })()
  ...
  generateScenarioData (scenarioType) {
    switch (scenarioType) {
      ...
      default:
        throw (() => { const error = new Error(`Unknown scenario type: ${scenarioType}`); error.code = ErrorCodes.'TEST_ERROR'; error.details = { category: 'testing' }; return error })()
    }
  }
