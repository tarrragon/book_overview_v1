...
- `coexisting-with-framework-managed-dom.md` — 客製 UI 留 framework 邊界外、用 CSS 控制視覺位置
- `component-boundary-and-js-impact.md` — JS 操作 framework 元件的邊界辨識
- `external-component-customization.md` — 在外部組件上加客製功能：以邊界為中心
- `external-component-collaboration-layers.md` — 跟外部組件合作的四層次
