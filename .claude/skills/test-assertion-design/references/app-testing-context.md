...
**脈絡提示**：APP 框架的 UI 執行緒排程受裝置效能影響，計時斷言在低階裝置或模擬器環境下特別不穩定。計時門檻應移至效能測試套件獨立執行。
...
**Version**: 1.1.0 — F1 類型編號對齊 SKILL.md（5-9）、F7 補類型 1-3 計時相關 section（Source: W1-027 第 1 輪審查）
