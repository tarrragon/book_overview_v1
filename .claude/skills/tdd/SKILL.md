...
Phase 3b 完成後，評估是否符合 Phase 4 豁免條件（跳過 4a/4c，直接執行 4b）。詳見 `references/phase4/rules.md`。
...
| Phase 1 功能設計 | `references/phase1/rules.md`（含 Decision Questions） |
| Phase 1 SOLID 拆分方法論 | `references/phase1-split-methodology.md`（CLI 工具、版本分配、報告範本） |
| Phase 2 測試設計 | `references/phase2/rules.md`（含 Decision Questions） |
| Phase 3 實作 | `references/phase3/rules.md`（含 Decision Questions、完成前執行清單） |
| Phase 4 重構 | `references/phase4/rules.md`（含 Phase 4d 流程改善回饋環） |
...
**Version**: 1.2.0 - Phase 參考資料路由更新至新目錄結構（phase2/3/4 指向 phaseN/rules.md）（0.17.0-W4-007）
