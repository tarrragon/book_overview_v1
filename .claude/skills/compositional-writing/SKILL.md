...
Naming 是這條原則最容易跳的子場景 — 第一版命名幾乎不對、四輪 review（第一版 / grep / cross-call-site / impl 洩漏）才收斂、見 [#84](/report/naming-as-iterated-artifact/) 跟 writing-code-comments 的 naming review 段。
