...
| baseline | 2026-05-06 | file-type-permission | 285 (3d) / 95 日均 | 2 | 0.7% | — | 候選 1 提醒級別降級；W10-047.4 補錄 pre-baseline 數據 |
| Wave +1 (W10-047.4) | 2026-05-07 | parallel-dispatch-verification | 132 (1.5d) / 88 日均 | 0 | 0% | -83.2% | 完全從 settings.json 移除 |
| Wave +1 (W10-047.4) | 2026-05-07 | bash-edit-guard | 439 (1.5d) / 293 日均 | 0 | 0% | -46.2% | 邏輯簡化但 matcher 未縮減；削減幅度低於預期 |
| Wave +1 (W10-047.4) | 2026-05-07 | acceptance-gate | 440 (1.5d) / 293 日均 | 10 | 2.3% | -46.2% | Fast-path 65% 命中但仍 spawn Python；削減幅度低於預期 |
| Wave +1 (W10-047.4) | 2026-05-07 | worklog-format-check | 68 (1.5d) / 45 日均 | 0 | 0% | -57.2% | 抽樣 counter=20；fast-path 已減 |
| Wave +1 (W10-047.4) | 2026-05-07 | utf8-integrity-check | 68 (1.5d) / 45 日均 | 0 | 0% | -57.2% | 抽樣 counter=44 |
| Wave +1 (W10-047.4) | 2026-05-07 | language-guard | 22 (1.5d) / 15 日均 | 0 | 0% | -34.3% | 抽樣 counter=4；觸發基數小，誤差較大 |
| Wave +1 (W10-047.4) | 2026-05-07 | comment-qa | 68 (1.5d) / 45 日均 | 0 | 0% | -57.2% | matcher 限定生效 |
| Wave +1 (W10-047.4) | 2026-05-07 | file-type-permission | 61 (1.5d) / 41 日均 | 5 | 5.5% | -57.2% 但 Action 比 ×7.8 | **rollback 條件命中（Action 比 > baseline×2 且 > 1%）；W17-157 評估** |
| Wave +1 結論 | 2026-05-07 | 加權合計 | 1298 (1.5d) / 865 日均 | 15 | — | -57.8% (vs 預估 -85%, 差距 27.2 ppt) | bay-quality-auditor 審計，信心度 0.75（觀察期 1.5d < 1 Wave）；觸發 acceptance #4 → W17-157 |
...
| Extended 結論 | 2026-05-11 | 加權合計 | 3054 (5.5d) / 555 日均 | — | — | **-81.9%** (vs 修正預估 -81.4%, 偏差 0.5 ppt) | W17-157 擴展觀察；信心度 0.95；短期樣本偏差為主因（+24.1 ppt 修正）；file-type-permission rollback 不再命中 |
...
### W10-047.4 Wave +1 評估結果（2026-05-07）
...
**綜合判斷**：延長觀察期。已建立 `W17-157` 追蹤三項議題：（1）預估方法論偏差（57.8% vs 85%）；（2）bash-edit-guard / acceptance-gate 進一步降級評估；（3）file-type-permission Action 比異常評估（決定 rollback / 調整 / 偶發接受）。觀察期延長至 W17-157 完成後重新評估。

### Extended 觀察期評估結果（2026-05-11, W17-157）
...
**綜合判斷**：三項判斷皆收斂。W17-157 結論：（1）預估方法論已修正（本文件新增兩類機制定義與公式）；（2）bash-edit-guard / acceptance-gate 維持現狀，不進一步降級；（3）file-type-permission 不 rollback，偶發接受。降級為長期生效。
...
**Version**: 1.2.0 — 新增「觸發消除 vs 處理降級」兩類機制定義表與修正預估公式；Extended 觀察期數據（May 6-11, 5.5d）填入追蹤表（實測 81.9% vs 修正預估 81.4%，偏差 0.5 ppt）；Extended 評估結果三項皆收斂，降級為長期生效（W17-157 / W17-184）
**Version**: 1.1.0 — W10-047.4 Wave +1 數據填入：實測 ~57.8% 削減（vs 預估 ~85%，差距 27.2 ppt）、file-type-permission Action 比 0.7% → 5.5% 命中 rollback 條件、延長觀察期決議、衍生 W17-157 追蹤三項議題
