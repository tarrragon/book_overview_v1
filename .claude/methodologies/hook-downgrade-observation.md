...
| Wave +1 (W10-047.4) | 2026-05-07 | file-type-permission | 61 (1.5d) / 41 日均 | 5 | 5.5% | -57.2% 但 Action 比 ×7.8 | **rollback 條件命中（Action 比 > baseline×2 且 > 1%）；延長觀察期評估** |
...
**Version**: 1.1.0 — W10-047.4 Wave +1 數據填入：實測 ~57.8% 削減（vs 預估 ~85%，差距 27.2 ppt）、file-type-permission Action 比 0.7% → 5.5% 命中 rollback 條件、延長觀察期決議、衍生延長觀察期追蹤三項議題
