...
|--------|----|---------|------|-----------|
| W3-001 | 整合測試全部通過、flaky test 修復 | 04-03 | 634/634 通過，0 failed | W1-002 / W2-001 / W3-006 外溢 |
| W3-002 | npm test 0 個失敗、100% 通過率 | 04-03 | 4719/4719 通過 | 同上 |
...
- 方案 2：`claim` 前 AC 自動驗證（W5-001 + W5-002）
- 方案 4：Ticket 年齡 stale 警告（W5-003）
