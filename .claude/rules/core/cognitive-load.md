...
> **理論依據**：W17-073 ANA 收斂結論（基線案例 W17-071）。本條款是 §三項核心閾值「功能職責數 > 2 須拆分」的特例豁免，**不取代**通用閾值，僅在符合全部 5 特徵時放寬。
...
> **後續觀測**：W17-055（30 天觀測 ANA）將追蹤本豁免條款命中率與漂移率；若觀測發現命中後常超時，啟動 W17-073 ANA 修訂。
