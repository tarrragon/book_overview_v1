...
const LIFECYCLE_EVENTS = {
  ...
  STARTUP_REQUESTED: 'LIFECYCLE.STARTUP_REQUESTED',
 ...
 * Content Script 事件類型
 */
const CONTENT_SCRIPT_EVENTS = {
  READY: 'CONTENT.SCRIPT.READY',
  ERROR: 'CONTENT.SCRIPT.ERROR',
  STATUS_UPDATE: 'CONTENT.STATUS.UPDATE',
  EVENT_FORWARD: 'CONTENT.EVENT.FORWARD'
}
 ...
 */
const TAB_EVENTS = {
  STATE_REQUEST: 'TAB.STATE.REQUEST',
  HISTORY_REQUEST: 'TAB.HISTORY.REQUEST',
...
const NAVIGATION_EVENTS = {
  HISTORY_REQUEST: 'NAVIGATION.HISTORY.REQUEST',
  PATTERN_REQUEST: 'NAVIGATION.PATTERN.REQUEST',
...
const MESSAGE_EVENTS = {
  ...
  ENQUEUE_REQUESTED: 'MESSAGE.ENQUEUE.REQUESTED',
  DEQUEUE_REQUESTED: 'MESSAGE.DEQUEUE.REQUESTED',
  VALIDATE_REQUESTED: 'MESSAGE.VALIDATE.REQUESTED'
}
...
const CONNECTION_EVENTS = {
  ESTABLISH_REQUESTED: 'CONNECTION.ESTABLISH.REQUESTED',
  CLOSE_REQUESTED: 'CONNECTION.CLOSE.REQUESTED'
}
