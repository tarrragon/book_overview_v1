...
// 匯出類別以供使用
//
// W4-006.2 重構：esbuild bundle 後 IIFE scope 內 PopupDiagnosticEnhancer 不會自動暴露到
// global；必須顯式注入 window.PopupDiagnosticEnhancer，否則 popup.js 內部
// `typeof PopupDiagnosticEnhancer !== 'undefined'` 檢查會 false → diagnosticEnhancer 永遠未初始化。
//
