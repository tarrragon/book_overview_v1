...
**核心開發流程（建議閱讀順序）**：
1. [🚨 核心開發原則](#-核心開發原則) - 必須遵循的基本規則
2. [📚 專案文件責任明確區分](#-專案文件責任明確區分) - 了解文件責任分工
3. [🤝 TDD 協作開發流程](#-tdd-協作開發流程設計師導向的團隊協作) - 核心開發工作流程
4. [🧠 TDD 驅動重構方法論](#-tdd-驅動重構方法論預期管理與工作日誌為核心) - 重構階段詳細指引

**專案特定規範**：
- [📦 Chrome Extension 與專案規範](#-chrome-extension-與專案規範) - 平台特定要求
- [🎭 事件驅動架構規範](#-事件驅動架構規範) - 架構模式指引
- [🤖 Agent 協作規範](#-agent-協作規範) - Sub-agent 協作模式
