---
id: 0.16.3-W4-015
title: 統一 所有 Skill SKILL.md 加入 Version + Last Updated 尾部標記
type: DOC
status: pending
version: 0.16.3
wave: 4
...
who:
  current: pending
  history: {}
what: 統一 所有 Skill SKILL.md 加入 Version + Last Updated 尾部標記
when: 待定義
where:
  layer: 待定義
  files: []
...
統一 所有 Skill SKILL.md 加入 Version + Last Updated 尾部標記
