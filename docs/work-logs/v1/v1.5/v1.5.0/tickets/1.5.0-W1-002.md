...
decision_tree_path:
  entry_point: IMP
  final_decision: 直接實作
  rationale: UI 改造需求明確，無需多方案評估
who:
  current: 待派發
  history: {}
what: 改造 前往書庫選單為摺疊 UI
when: v1.5.0 W1
where:
  layer: 待定義
  files:
  - src/popup/
why: 日後支援多書城時清單會無限增長，需摺疊收納
how:
  task_type: Implementation
  strategy: 將書庫跳轉選單從平鋪列表改為可展開收合的摺疊元件
acceptance:
- '[x] 書庫跳轉選單為摺疊 UI，點擊展開收合'
tdd_phase: phase1
tdd_stage:
- phase1
- phase2
...
started_at: '2026-06-26T10:02:45'
completed_at: '2026-06-26T10:17:58'
created: '2026-06-26'
updated: '2026-06-26'
---
...
**Completion Time**: 2026-06-26T10:17:58
**Executing Agent**: 待派發
