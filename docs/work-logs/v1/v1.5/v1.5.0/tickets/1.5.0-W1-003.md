...
where:
  ...
  files:
  - src/popup/
why: 當前不在任何書城書庫頁面時顯示提取按鈕會誤導使用者
how:
  task_type: Implementation
  strategy: 偵測當前分頁 URL 是否匹配書城書庫頁面，不匹配則隱藏提取按鈕
acceptance:
- '[x] 非書庫頁面時提取按鈕隱藏，書庫頁面時正常顯示'
tdd_phase: phase1
tdd_stage:
- phase1
- phase2
...
started_at: '2026-06-26T10:18:16'
completed_at: '2026-06-26T10:34:38'
created: '2026-06-26'
updated: '2026-06-26'
---
...
**Completion Time**: 2026-06-26T10:34:38
**Executing Agent**: 待派發
